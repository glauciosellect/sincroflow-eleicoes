...
import { LayoutDashboard, FileText, Users, MessageSquare, Contact, Settings, CalendarDays, X, Menu, BarChart3, FileWarning, Image as ImageIcon, Plug, Award, ShieldCheck, Map, Globe, Sparkles, Radar, Wallet, Building2, UserCheck, Scale, ClipboardList, Network, Trophy } from 'lucide-react'
...
const navItems = [
  ...
  { section: 'CAMPANHA', items: [
    ...
    { href: '/lideres', label: 'Gestor de Líderes', icon: Trophy, module: 'equipe' },
